...
public class CrearCuidador implements Comando {
    ...
    public void ejecutar(String[] parametros, Vista vista) {
        ...
        if (parametros.length == NUMERO_PARAMETROS_MIN) {
            controladorUsuario.regsitrarCuidador(parametros[0], parametros[1], parametros[2], parametros[3], null, null, null, parametros[4], 0, parametros[5], null); // @TODO completar para que funcione con los distintos archivos
        } else {
            controladorUsuario.regsitrarCuidador(parametros[0], parametros[1], parametros[2], parametros[3], null, null, null, parametros[4], 0, parametros[5], null); // @TODO completar para que funcione con los distintos archivos
        }
    }
